...
| World-generation code: terrain, hydrology, regions, climate, danger, cultures, routes, the rebuild chain | [../tooling/world-generation/README.md](../tooling/world-generation/README.md) | [world/50](world/50-hydrology-climate.md), [research/world-terrain/](research/world-terrain/README.md), the lore row, [quests/20](quests/20-world-provisions.md) when placing anything |
