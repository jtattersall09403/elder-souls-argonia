...
| Character stats, attributes, skills, progression, levelling, birthsigns | [world/76-stats-progression.md](world/76-stats-progression.md) + decision [0019](decisions/0019-stats-system-workstream-and-placement.md) — **read before adding any per-character number**; design workstream S, implementation Phase 10c |
