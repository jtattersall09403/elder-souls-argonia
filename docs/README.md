...
| Water: rendering, the water query, tide/season levels, buoyancy, underwater | [world/60-water-traversal.md](world/60-water-traversal.md) + decision [0025](decisions/0025-phase8b-water-implementation-shape.md) + research [three.js water](research/water-rendering-threejs.md) + [shore waves/edges/wet sand/ripples](research/water-edges-and-shore-waves.md); code in `packages/game-core/src/water/`, `apps/world-studio/src/water/`, compile `worldgen/compile_water.py` |
