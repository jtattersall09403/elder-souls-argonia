...
| Vegetation macro→meso→micro placement, clumping, waterline rules | [openworld-vegetation-placement-architecture.md](openworld-vegetation-placement-architecture.md), [shipped-world-placement-rules.md](shipped-world-placement-rules.md), [vegetation-density-design.md](vegetation-density-design.md) |
| Ruin taphonomy, Xanmeer form | [xanmeer-mesoamerican-reference.md](xanmeer-mesoamerican-reference.md) |
| Rewards, loot tiers, faction payoffs | [tes-quest-and-faction-rewards.md](tes-quest-and-faction-rewards.md) |
...
| 0.5–2 km | **Canopy silhouette and height** | already owned by [vegetation-composition-rules.md](vegetation-composition-rules.md) |
...
| 0–50 m | **Ground palette + clutter vocabulary** | see [skyrim-morrowind-landscape-texture-granularity.md](skyrim-morrowind-landscape-texture-granularity.md) |
...
[openworld-vegetation-placement-architecture.md](openworld-vegetation-placement-architecture.md) §4.2).
