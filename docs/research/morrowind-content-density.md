...
- **Quests originating per settlement** (from the faction quest-giver tables
  mined in [morrowind-cast-structure.md](morrowind-cast-structure.md) plus
  city pages):
...
| Quests per km² | ~20 | **~15–20 at maturity** across authored land — which at our land area means raising the **mature finite-quest target from 300–350 to ≈ 450–550** (Milestone 1 unchanged at ~170–210) |
