...
- [16h-catalogue-wide-steps-audit.md](16h-catalogue-wide-steps-audit.md) — which steps from 16h part 2 to Phase 15 run over a whole catalogue, measured counts, the sample-first shape for each, and the tools with no place selector.
- [16h-handoff-2026-09-25.md](16h-handoff-2026-09-25.md) — the Codespaces migration hand-off: every lane's state at the 2026-09-24 cut, its last commit, what was mid-flight, its report in the transcripts bundle and the line that relaunches it; open owner calls; what changes on Codespaces.
- [16d-ledger.md](16d-ledger.md) — the 1:1 registration that replaced the audit's, the apron build numbers, the gated tests, the beyond-border sea.
