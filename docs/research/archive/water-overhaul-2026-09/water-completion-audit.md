...
| Studio map and affected semantic world data match changed water coverage/stages; owner addition2026-09-07 | Shared low/base/maximum physical coverage export required; map currently uses legacy hydrology/flood rasters. Preserve natural-terrain siting versus graded-runtime distinction and ecological classifications. [Implementation direction](water-coverage-pipeline.md) | open |
