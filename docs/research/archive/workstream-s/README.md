# Workstream S — closed working papers (provenance only)

**Do not use anything in this folder as a spec.** Workstream S (the character
system: attributes, skills, progression, combat maths, the danger ladder) is
**closed**. These are the working papers it produced on the way there, kept for
provenance — who asked what, what was rejected, and why.

The **live** design is, in this order:
...
poise and posture, the estus flask, a 50 % spell-cost-reduction cap (it is
75 %), a four-band sneak-multiplier table, and a "wildlife" D0 band. Several
also predate the round-2 lethality retune, so their numbers are stale. If you
find yourself reasoning from a number in here, stop and read module 76.
