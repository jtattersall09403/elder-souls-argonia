...
| [black-marsh-climatology.md](black-marsh-climatology.md) | The province macro-climate: canon anchors plus real wetland climatology reduced to raster formulas (temperature, rain, flood cycle, mist). Read by `worldgen/landcover.py`, `shape_province.py`, `packages/world-time`. | live design input |
