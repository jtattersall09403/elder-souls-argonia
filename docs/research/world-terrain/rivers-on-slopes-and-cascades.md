...
clipmap, decision 0025). Companion docs: [water-rendering-threejs.md](../rendering/water-rendering-threejs.md),
...
flow-map or slope concept (verified in [water-rendering-threejs.md](../rendering/water-rendering-threejs.md) §1).
