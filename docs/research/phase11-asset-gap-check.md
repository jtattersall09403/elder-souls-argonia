...
[settlement-asset-inventory.md](settlement-asset-inventory.md) (what we hold),
[settlement-kit-sourcing-log.md](settlement-kit-sourcing-log.md) (what 6b took
and rejected — read its skip table before proposing any download),
[mined-interior-assembly-and-settlement-form.md](mined-interior-assembly-and-settlement-form.md)
