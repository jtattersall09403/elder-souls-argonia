...
**Premise:** A contested attempt to revive an order that Skyrim’s Veezara calls extinct. The line asks whether birth, tradition, state power or consent can recreate the Shadowscales.  
...
|---|---|---|---|---|
| SS01 | Last of the Scale | A dying contract-killer claims to be the last trained Shadowscale and asks the player to recover a list of surviving initiates before the An-Xileel or Dark Brotherhood does. | **P11/P12/P13:** `LOC shadowscales.safehouse_ruin`; sickroom, hidden archive, two entrances, document fallback and one small ambush. | L08–L09, L29; A02, V03 |
| SS02 | Writ Without a King | The first test is a historical writ whose issuing authority no longer exists. The player can execute, investigate, expose or void it; each choice establishes the order’s legal philosophy. | **P11/P12/P13:** Target home/work route, public records office, rooftop/underwater approaches, witness sockets and non-lethal resolution. | L08–L09; A02, A18, V02–V03 |
...
| SS04 | Born Under Shadow | An adult born under the Shadow is being claimed by rival revivalists. Their birth sign does not settle their wishes, fitness or obligations. | **P11/P12/P13:** Two faction meeting spaces and neutral hearing room; adult claimant home/schedule; limited duel arena. | L08, L33; A02, V03 |
| SS05 | A Brother from Falkreath | A Dark Brotherhood emissary offers training, contracts and Listener legitimacy in exchange for absorption. The emissary is useful, courteous and plainly seeking control. | **P11/P12/P13:** Guest safehouse, ritual chamber and discreet dock/escape; 4-actor negotiation marks. | L09, L29; A02, V03 |
...
| SS08 | The State’s Hand | The Veiled Reed offers an official charter: legal protection and resources in return for state-directed contracts. Refusal leaves the order vulnerable but independent. | **P11/P12:** An-Xileel office, Shadowscale council chamber and branch-specific banner/guard state only. | L02, L08–L09; A02–A03 |
...
**Premise:** A recognisable Thieves Guild adapted to canals, boats, flooded districts and rootworm routes. The line escalates from local theft to a province-famous heist.  
...
**Premise:** Black Marsh scholars operate between local custodians, the Synod and College of Whispers after the Mages Guild’s dissolution.  
...
| SA04 | The College at the Door | College of Whispers envoys offer spirit techniques and independence from Imperial bureaucracy while hiding a dangerous binding experiment. | **P11/P12/P13:** Guest laboratory, containment room and small magical encounter space. | L24, L26; V09, A20 |
| SA05 | Synod in the Cellar | The Synod offers funding, instruments and publication but demands exclusive custody of discoveries. | **P11/P12/P13:** Synod office, secure cellar, inventory/evidence sockets and negotiation scene. | L24–L25; V09, A20 |
...
| NI05 | Teeth of Sithis | A violent sect claims all destruction is sacred change. The player must distinguish sincere theology, criminal opportunism and state provocation. | **P11/P12/P13:** Cult hideout, Nisswo debating hall and damaged public site; 3 small encounter/social routes. | L04–L05, L33; V03, A18 |
...
| MR03 | The Borrowed Tree | A Lukiul district planted a Hist cutting generations ago. A nearby tribe claims it was taken without consent. | **P4/P11/P12:** Urban Hist courtyard, tribal settlement and civic hearing room. | L03, L16; A16–A17, A24 |
...
| ID | Quest | Narrative/choice | World-generation provision | Lore/assets |
|---|---|---|---|---|
| LW01 | Citizen of No Hist | A resident denied civic registration because no local Hist claims them asks the League for help. Records, prejudice and real security concerns intersect. | **P4/P11/P12/P13:** Civic registry, claimant home, An-Xileel office and hearing room. | L02–L03, L16; A20, V12 |
...
Former prisoners, warders and families campaign over Blackrose’s future: reform, abolition, local control or renewed high-security use.

| ID | Quest | Narrative/choice | World-generation provision | Lore/assets |
|---|---|---|---|---|
| BC01 | The Cell Left Open | A missing prisoner may have escaped, been murdered or been quietly released. | P11/P12/P13: Blackrose cell wing, records office, drain route and witness schedules. | L30; V06, A18, A21–A22 |
| BC02 | Names Scratched Out | Destroyed registers conceal political detainees and ordinary violent offenders together. | P11/P12/P13: archive fire site, duplicate record store and family contact locations. | L30; A20–A22 |
| BC03 | The Warden’s Mercy | A respected warden’s informal releases saved innocents and empowered a criminal network. | P11/P12/P13: warden home, prison office, released-person safehouse and hearing room. | L30; V06, A20 |
| BC04 | Riot Without a Banner | A prison riot is being prepared by factions with incompatible aims; prevention may preserve abuse. | P11/P12/P13: yard, cell blocks, armory, medical room and 2–3 local prison states; actor cap. | L30; A21–A22, V06 |
| BC05 | What Blackrose Becomes | Choose reform, abolition/memorial, local defensive prison or renewed state institution. | P11/P14: prison banner/guard/service variants and epilogue notices only. | L02, L30; V06, A21–A22 |
...
Survivors’ descendants, scholars and political actors fight over the truth of Lilmoth’s 4E 48 catastrophe.
