...
| **Writing any named NPC** — main quest, faction, local, texture | [35-cast.md](35-cast.md) — **mandatory before naming anybody**: depth tiers, the six character rules (Morrowind desk model, UESP-mined), the canon naming system, the principal cast, per-faction desks and arguments, shared places and shadow networks, the oddities roster, the texture kit. |
