# Fourth-Era political, cultural and geographic frame
...
- counter-espionage;
- monitoring foreign and domestic political threats;
- protection of sensitive Hist and state knowledge;
- investigation of cults, smugglers and assassination networks;
- manipulation of records and public narratives;
- emergency liaison with city and Hist authorities.
...
Argonian reverence for Sithis cannot be written as generic evil cultism. Nisswo understand Sithis through change, endings, transformation and uncertainty. Their interpretations are plural and often suspicious of fixed dogma.

The **Unbound Root** is a radical movement, not the definitive Argonian faith. Its doctrine argues:

- the Hist nurture Argonians but also influence form, memory and social belonging;
- modern authorities turn that bond into proof of citizenship and obedience;
- ancient institutions preserved continuity at the cost of individual freedom;
- meaningful change requires the possibility of severance;
...
The official fragment describes the **Eye of Argonia** as a priceless king’s jewel and the key to a Lost City. The game deliberately preserves uncertainty about its original status.

Project interpretation:

- the Eye is a cut gem in an old setting;
...
- officials treated participation as inherited and compulsory;
- some communities were excluded;
- later state institutions used records and selected dream testimony for classification;
- the original consent provisions were concealed;
- the Root remained spiritually significant to many communities.

The cult intends to sever the Root at its sanctuary. Because many important modern relationships depend on it, full severance would silence or disrupt several major Hist and destabilise communities across Argonia. This is represented by selected local Hist/NPC state variants and a broad epilogue—not dynamic terrain.

## 9. Danger geography and city roles

Danger geography is a controlling design input. **The authoritative danger map
is the generated, owner-approved danger field** (world compile output, viewable
as the studio's "danger" layer; model in `worldgen/society.py`, decision 0007) —
it supersedes the draft image this plan originally referenced (review fix,
2026-08-23; the image predated the built world and was never committed). The
danger-tier vocabulary below maps onto that field via the table in
[20-world-provisions.md](20-world-provisions.md) §12.
...
The demographic percentages are community planning priors, not canonical census figures. They should guide ordinary population composition, architecture and institutional presence without becoming rigid quotas.

The main quest’s compulsory route progresses:

```text
managed Stormhold/Alten Corimont marsh
→ early protected visit to safe Helstrom
→ outer-city and coastal treasure hunt
→ D3 regional ruins and infiltration
→ D4 route preparation
→ D5 expedition beyond Helstrom
→ Lost City and Root sanctuary
```
