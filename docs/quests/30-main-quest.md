...
**Full sheets live in [35-cast.md](35-cast.md) §55** — want, contradiction,
...
|---|---|---|---|
| **Nesh-Deeka** | Veiled Reed field handler | Believes records expose power; alters records to protect people — her Director's crime at a smaller scale. The game's Caius Cosades and the player's whole feeling about the Reed | loyal handler, reform ally, state propagandist, dead witness with documentary fallback |
...
| **Never-Writes-Twice** | Veiled Reed hardliner *(new; runs MQ03→MQ31)* | The only officer in the service who files honest reports, which makes her the player's most dangerous enemy. She is right about the player. Never write her as corrupt | institutional nemesis, reluctant witness, successor Director, or replaced by someone worse |
...
| **The Last Warden** | Ancient Wamasu guardian of the sanctuary | Bound to the Accord's consent conditions, not to any modern faction. Will **wait** for a bearer who has understood the records, which is worse than attacking | shared final boss; optional weakening/non-lethal route if records are understood |
...
|---|---|---|---|---|---|
| MQ01 | No Name on the Work Roll | D0–D1 | Character creation occurs during processing on a penal work barge near Alten Corimont. The player can cooperate, remain silent or antagonise staff without acquiring a fixed biography. **The detail is an Owing gang** (lore: topics/labour-and-bondage.md): nobody aboard is a prisoner in a cell, everybody aboard owes months, and the ledger is read out at processing along with the months added for food. Two of the gang are visibly **washed out** from years kept away from their Hist. The player never has this explained; they will meet the same institution in Act II and understand the Root of Accord before it is described. | **P2/P4/P11/P12/P13:** `LOC opening.work_barge` and `opening.work_camp`; prison-processing interior; confiscated-property container; 6–8 NPC schedule/scene marks; managed-marsh escape perimeter; fixed prisoner/guard loot. | L13, L17–L20; V06, V07, A13, A21–A22 |
| MQ02 | When the Reeds Opened | D1 | An Unbound Root cell attacks an An-Xileel courier attached to the work detail. A nearby Hist withdraws from its attendants as the camp collapses into mutiny, fire and shallow-water escape. The player chooses one witness to save. **Delivery D-B:** the collapse is a *corridor of small authored pockets* in the Helgen model — crowd audio, fire and set dressing on rails, six active actors maximum, never a simulated riot. | **P3/P6/P7/P8/P9/P11/P13/P14:** Shallow channels, reed cover, one climbable root route, one rowboat escape and one combat route; `STATE opening.camp={orderly,attacked,aftermath}`; witness rescue sockets; 2–3 small encounter spaces; no terrain deformation. | L03–L05, L23; V01, V07, A07–A08, A13, A24 |
...
| MQ09 | The Map Beneath the Prison | D2 | Blackrose Prison is a ruin held by the **Blackguards' heirs** — prison-born families three generations deep, with Umbriel's undead in the lower levels (owner decision Q3; lore: topics/prisons.md). Its old confiscation ledgers show that an explorer carrying an Eye route-tablet died in custody. The archive wing is the residents' proof of their own history, so the records can be obtained by bargaining with the heirs, resident contacts, burglary or an underwater maintenance passage. Any illicit route can go loud: a raised alarm turns the exit into a timed escape through flooding maintenance tunnels with armed residents behind and the undead levels below — dangerous, survivable, and never mandatory. | **P2/P4/P8/P9/P11/P12/P13:** `LOC blackrose.archive_wing`, occupied yard and submerged maintenance tunnel; cell/office/records interiors reoccupied as homes; multiple access terms set by the heirs; resident schedules; sealed undead lower-level boundary; no mandatory battle; fixed map-tablet item. | L30, L10–L11; V06, V10, A18, A20–A22 |
...
| MQ11 | The Surveyor’s Lie | D1–D2 | A Gideon estate preserves an Imperial survey whose neat roads deliberately omit a forbidden marsh corridor. The surveyor’s descendant, estate workers and an An-Xileel land office each hold part of the truth — but **the answer is not in any of their papers: it is standing in the omitted corridor**, and the player has to walk a road that is on no map to find out why it was left off. The estate workers are held under **Owings** and know the corridor because they were the ones sent into it (lore: topics/labour-and-bondage.md). *(Discover in danger, decide in council: was manor + archive + records with no physical beat.)* | **P2/P4/P11/P12/P13:** `LOC gideon.survey_estate`, land office and omitted roadside shrine; manor, archive cellar, workers’ quarters and field route; stealth/social/legal approaches; historic map overlay as evidence. | L01–L02, L16–L18; V06, V12, A19–A20 |
| MQ12 | Ash Written in Water | D2–D3 | Near Thorn, a Dunmer family’s slave-road journal contains a phonetic rendering of a Lost City route-name. **The journal is in the flooded cellar and the family will not go down**, so the player dives for it while the argument continues above — and the water is *why* the record is phonetic, half-dissolved and disputable, which makes the hearing afterwards a real interpretive problem rather than a formality. Argonian veterans and Dunmer residents dispute whether it should be preserved, tried as evidence, or destroyed. *(The hearing is the payoff; the dive is the quest.)* | **P2/P4/P8/P11/P12/P13:** `LOC thorn.border_archive` and `poi.slave_road_memorial`; mixed neighbourhood, flooded cellar, memorial and D3 road segment; hearing scene; evidence and grave sockets; no large battle. | L01, L13, L16; V05, V12, A19–A20 |
...
| MQ19 | The Child of Two Hist | D2 | Two communities claim responsibility for an Argonian whose egg clutch and upbringing link them to different Hist — and **the subject has left**. Both communities are searching; the player finds her first, somewhere neither would think to look, visibly **washed out** because she has kept herself away from both trees for two years (canon *gloor*: traits fade with distance and return on coming home). The question stops being whose claim is better and becomes whether to tell anyone she has been found. An-Xileel records and Tree-Minder testimony conflict; her own wishes are the only thing nobody has asked for. *(Was two settlements and a hearing hut; the hearing now happens only if the player causes it.)* | **P4/P11/P12/P13:** Two nearby `LOC` settlements and a neutral hearing hut; stable family homes, egg-pool/ritual spaces and travel route; no child asset dependency—subject is an adult; `STATE identity_case` variants reflected through NPC schedules. | L03, L12, L16, L22; A15–A17, A19–A20 |
...
| MQ24 | The Missing Shadowscale | D3 | A vanished Shadowscale survivor knows the Lost City’s warding tradition. **Delivery: pursuit by inference, not a chase.** At each of three sites the quarry is already gone and the player reads *which way* from what the place gives up — a dry stair with one wet print, a boat missing from its ring, birds up over the wrong roof — then arrives at a static intercept. A wrong reading costs the best evidence, never the quest. They can be persuaded, killed, rescued or replaced by their notes. *(Was "a staged pursuit path" with rooftop exits — a free-roaming fleeing NPC over complex geometry, the single worst scripting pattern available to us.)* | **P8/P9/P11/P12/P13:** `LOC shadowscale.safehouse_mainquest` distinct from faction headquarters; rooftop and water exits; target apartment, ambush lane and note fallback; no dependency on Shadowscale faction membership. | L08–L09, L29; A02, A18, A20; V02–V03 |
| MQ25 | Council Behind Closed Gates | D0 | Helstrom’s council hears the Veiled Reed, Nisswo, Tree-Minders and cult-adjacent witnesses. The player can expose both sides, protect cover, or secure an expedition. Mid-session, the council is attacked — a small cult strike team or, on some paths, **Never-Writes-Twice's** superiors staging a provocation she refuses to sign off and reports honestly afterwards, which is how the player learns what she is. **Delivery rule:** the fighting happens in an *adjoining cleared chamber* the player is pushed into, and who survives is decided by **where the player stood and who they pulled through the door** — never by allied combat AI keeping named NPCs alive. Who survives changes who reaches the sanctuary in MQ31. Attendance and arguments vary; the physical scene remains small. | **P4/P11/P12/P14:** `LOC helstrom.closed_council`; 8–10 actor marks but only 4–6 simultaneously active; side rooms for private bargains; one compact COMBAT-cleared chamber configuration for the mid-session attack (3–4 hostiles, existing humanoid assets); witness-protection scene sockets; local guard/NPC state variants; streaming prefetch for nearby city only. | L02–L06, L32–L33; A19–A20, V12 |
...
Six regional leads with the same shape (arrive in city, find document, learn a
thing) is the structural failure the whole treasure hunt is exposed to, however
good each quest is individually. Four mitigations, in force:

1. **One verb each, and no repeats.** MQ09 burglary/bargain, MQ10 dive, MQ11 walk
   the unmapped road, MQ12 dive-and-hearing, MQ13 urban infiltration under
   residents' eyes, MQ14 climb and night-sail. A lead may not be re-briefed with a
   verb another lead already owns.
2. **One lead costs something.** At least one of the six can only be taken by
...
3. **One lead is wrong.** One fragment is a forgery — a good one, planted early —
   and is detectable only by cross-referencing against a *different* lead. Taking
   only the minimum four can therefore mean triangulating from a lie, which does
   not block MQ15 but sends the player to a wrong first mark in MQ23 and costs
   them a real journey. This rewards over-collection with something better than
   completion, and it makes Sings-Over-Stone's pedantry mechanically valuable.
