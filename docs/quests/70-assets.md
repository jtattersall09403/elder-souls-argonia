# Narrative asset catalogue and no-new-art plan
...
| Code | Source | Specific reusable material | URL |
|---|---|---|---|
| A01 | Argonian Xanmeer Tileset — Modder’s Resource | 85 modular structural/damaged Xanmeer meshes; Lost City, observatories, sanctuaries and ruins. | https://www.nexusmods.com/skyrimspecialedition/mods/181193 |
| A02 | Shadowscale Set Reborn | Beast-compatible assassin armour, cowl, sword and dagger for the Shadowscale line. | https://www.nexusmods.com/skyrimspecialedition/mods/79717 |
...
| A06 | Last Warden boss build (in-vault) — with Mihail Wamasu as deferred optional | **Final boss = ancient Xal-Krona (Argonian Behemoth), boss decision 0030:** vanilla werewolfbeast rig (121 clips (the count at the time; current in docs/FACTS.md) incl. power combos, sprint attacks, bleedout/kneel — the stand-down state) + the BM&V pool's armoured-daedroth meshes rigged to that skeleton, re-textured Argonian scale + amber sap emissives; spriggan rig for optional root-guardian adds. All sources already in vault; re-material class only. The Mihail Wamasu (custom Megalania-derived skeleton; audio credits CDPR and must be replaced on any ingest) is **deferred** — optional overworld legendary later, never on the critical path. | vault (vanilla + BM&V); wamasu deferred: https://www.nexusmods.com/skyrimspecialedition/mods/158860 |
...
| A10 | Depths of Skyrim — An Underwater Overhaul | Underwater plants, wreckage and scene-composition resources. | https://www.nexusmods.com/skyrimspecialedition/mods/26913 |
| A11 | Sailable Ship VR and SE | Ship models/interiors and proven helm/wind/control references. | https://www.nexusmods.com/skyrimspecialedition/mods/72070 |
...
| A19 | Beyond Skyrim — Wares of Tamriel | Saxhleel weapons/clutter, trade goods, food and broad provincial material culture. | https://www.nexusmods.com/skyrimspecialedition/mods/31519 |
| A20 | Oaristys & Tony67 Modder’s Resource Pack | About 500 meshes: treasure, shelves, paper, alchemy, food, skeletons and clutter. | https://www.nexusmods.com/skyrim/mods/16525 |
| A21 | Interactive Hanging Chains and Cages | Animated/interactive restraint and prison set pieces. | https://www.nexusmods.com/skyrimspecialedition/mods/141602 |
| A22 | Metal Cages and Imperial Jails | Prison cages, cell doors and Imperial detention dressing. | https://www.nexusmods.com/skyrimspecialedition/mods/36897 |
...
| Code | Source family | Uses |
|---|---|---|
| V01 | Hjaalmarch/Morthal | Reeds, dead trees, fog, wet ground, boardwalks and managed-marsh vocabulary. |
| V02 | Riften/Ratway/Thieves Guild | Docks, canals, cisterns, sewers, vaults, secret doors and guild interiors. |
| V03 | Dark Brotherhood | Assassin clothing, sanctuary architecture, torture room, contracts and Blade of Woe. |
| V04 | Blackreach/Eldergleam | Huge roots, glowing fungi, cavern light, ancient machinery and sacred-tree spaces. |
| V05 | Dragonborn/Solstheim | Telvanni forms, giant fungi, ash-border material, Dunmer props and organic architecture. |
| V06 | Imperial forts/jails | Cells, gates, offices, records, barracks, carts and institutional interiors. |
| V07 | Fishing Creation | Boats, nets, fish, traps, Argonian fishing rod and waterfront clutter. |
| V08 | Nordic/draugr traps | Pressure plates, gates, blades, pendulums and modular puzzle mechanisms. |
| V09 | College/Saarthal | Mage props, excavation clutter, wards, magical apparatus and scholar interiors. |
| V10 | Ships, caves and mines | Shipwrecks, mine supports, natural caves, tunnels, cranes and cargo. |
| V11 | Thieves Guild/Nightingale equipment | Recognisable stealth armour and heist tools; optional, not compulsory oaths. |
| V12 | Common city/house kits | Recombined for Lukiul, Imperial-descended and mixed-city buildings where appropriate. |

## 54. Main-quest asset plan

| Need | Existing solution |
|---|---|
| Penal work barge and small ferries | V07, A13; larger reference from A11/A12 |
| Managed marsh opening | V01, A17, A25 |
| Hist and Root spaces | V04, A17, A24; lighting/audio/particles distinguish affected states |
...
| Faction | Core sources |
|---|---|
| Shadowscales | A02, A03, V03, A18, A20–A22 |
| Thieves Guild | V02, V11, A10, A13, A18–A20 |
| Marsh Charter | A03–A08, V06, V01 |
| Sunken Archive | A01, A10, A20, V04/V09 |
| Nisswo | A15–A17, A20, V09/common robes |
| Many-Root | A15–A17, A24–A25, V01/V04 |
| Reed-Sail Compact | A11–A14, A19, V07 |
| League of Open Water | A15, A18–A20, V12 |
...
6. A18/A20 heist, archive and undercity assets.
7. A02/A03/A04 Shadowscale and Argonian equipment.
8. A07/A08/A09 marsh/coastal creature set.
9. A19 cultural clutter and trade goods.
10. A21–A23 prison and dungeon interaction resources.

Every ingested asset should record dimensions, collision/material response, climbability, water suitability, LOD, sockets and credit source.
