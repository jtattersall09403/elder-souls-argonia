...
| **Water: how wide a fall is DRAWN** — the compiled width is right (verified x1.00 against the stream feeding every one of the 16 falls) and the sheet now feathers, but it still holds alpha above 0.5 out to ~74 % of that width while the strip paints its whitewater over a much narrower core. Making the sheet narrower than its channel all the way down is an owner-visible call about how wide waterfalls should look, not a bug | water round 2 close-out, 2026-09-09 | the owner has said how wide a fall should read, and the sheet is drawn to it |
| **Water/light: waterfalls read warm ivory because MIDDAY SUN IS ORANGE** — with the owner's locked `warmthBias = 1.0`, `sky/lightRig.ts:249-259` mixes the noon sun 90 % toward golden and then scales it again, giving `sunColor = [1.00, 0.62, 0.29]` at midday. The falls' albedo is neutral white end to end; balancing sky against sun inside the kit recovered blue from 0.46 to 0.55 and that is as far as the kit can legitimately go. If white water against grey rock is wanted, `warmthBias` is the lever — an owner call, since 1.0 is their locked default | water round 2 close-out, 2026-09-09 | the owner has ruled on midday warmth, and water reads as they want it |
