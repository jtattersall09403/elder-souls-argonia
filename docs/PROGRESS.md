...
| 8c — weather and atmosphere | in progress | started 2026-08-28: weather state machine from climate fields, computed WTHR-checklist parameter blocks, clouds, rain/squall/storm, three mist regimes, wet-surface response, env-query coupling, quality tiers (module 55 §97–98; research doc weather-clouds-rain-threejs.md) |
