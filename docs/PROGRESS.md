...
- **Phase 11 Round A follow-up (in progress, 2026-09-05)** — the maps are being
  rebuilt as an interactive studio view with real footprints and authored
  orientation; the Round A questions come back to you when that is ready.
