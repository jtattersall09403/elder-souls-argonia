...
- **16g delivered 2026-09-19, owner check pending** ([0078](decisions/0078-places-adapt-to-the-frozen-world.md), [0080](decisions/0080-the-chain-runs-by-dependency-not-position.md), [ledger §3](research/phase16/16g-ledger.md), [remedy plan](research/phase16/16g-remedy-plan.md)): the 2D map (`?cat=1`) and the ledger, per § Owner check in the [brief](phases/16-foundation-and-places/16g-macro-plot-places-adapt.md). Four calls: (1) the pirate-freeholds zone keys its water to a border marsh sheet while its lore says river (re-solve the zone onto the Onkobra reach, or rewrite the 21 records); (2) Blackrose's centre sits 109 m off its lake (move the centre in 16h's city pass); (3) the stronghold is the Empty Steading, Rockpoint kept (reversible); (4) the 13 records in `world/sources/sites/plot-homeless-accepted.json` (loosen, re-type, cut, or unfreeze water to give the bundle its 27 missing bodies).
- **16h plan (2026-09-20), a read before "deliver 16h part 1"**: the
  [brief](phases/16-foundation-and-places/16h-settlement-runtime-and-kit-qa.md)
  § Owner check-ins and § The story. Two facts it surfaced for you: the
  shipped track-clearance receipt from 16g reports zero plants removed
  (part 1 diagnoses it); adding scatter as a local patch does not
  exist yet (part 2 builds it). The 16g calls above are applied at the
  start of part 2 if you have given them by then.
