...
| C — parallel combat workstream (sandbox; feeds 10b) | done: measured weapon reach | All 35 melee weapons and 245 attacks measured from mounted geometry and sourced motion. Inventory separates length/reach; AI uses measured reach. Root tests/typecheck pass on isolated combat snapshot; nine attack/reach scenes pass, including live dagger/sword comparison. See [0040](decisions/0040-animation-packs-and-combat-parallel-pass.md) round 13. |
