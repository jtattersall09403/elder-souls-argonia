...
| Stats lab (Opus lead, 0087) | in progress: round 1 delivered 2026-09-24 (model + curve port in `game-core/src/stats`, proved equal to the sim, [0088](decisions/0088-the-stats-model-lives-in-game-core-and-reads-injected-data.md)); rounds 2–3 next | [brief](phases/lanes/stats-lab-lane.md) |
