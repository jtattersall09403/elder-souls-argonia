...
| Vegetation renderer — cells built once, LOD on the GPU, no rebuild on movement | in progress: round 0 delivered 2026-09-20 ([0082](decisions/0082-vegetation-cells-are-built-once-and-the-gpu-picks-the-rung.md), [baseline](research/vegetation/renderer-rewrite-baseline.md); jungle is the lane's only measuring site, owner 2026-09-20); next: "deliver vegetation renderer rounds 1 and 2" (one session, owner 2026-09-20; old path removed only after the round-1 targets are met); must close before "deliver 16h part 1" | [brief](phases/lanes/vegetation-renderer-lane.md) |
