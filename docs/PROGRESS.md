...
| Vegetation renderer — cells built once, LOD on the GPU, no rebuild on movement | in progress: rounds 1–2 delivered 2026-09-21 ([0082](decisions/0082-vegetation-cells-are-built-once-and-the-gpu-picks-the-rung.md)); performance rounds with the owner's walks under way, nine fixes committed locally (last 0a7e1696: mid-rung shadows, terrain LOD by distance, ground-cover mesh reach; HUD triangle attribution) (brief § Performance rounds); ground cover now in the lane; next: a fresh agent with "you are continuing performance lane work in line with my feedback" plus the owner's HUD numbers; closes when the jungle walk is smooth, then 16h | [brief](phases/lanes/vegetation-renderer-lane.md) |
