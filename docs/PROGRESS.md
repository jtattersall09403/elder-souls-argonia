...
| Combat sandbox (Opus lead, 0087) | in progress: rounds 0–3 delivered 2026-09-24 (runtime in `packages/character/src/combat`, [0089](decisions/0089-the-combat-runtime-is-a-package-with-an-injected-host.md); every built weapon in the starting pack; arrow calibration [0090](decisions/0090-arrow-damage-is-calibrated-to-a-masters-warbow-headshot.md), two-hander swing ×0.85, sword crit, timing panel; off hand: dual wield, torch, carried light [0091](decisions/0091-the-off-hand-holds-a-shield-a-weapon-or-a-light.md)); rounds 4–5 next | [brief](phases/lanes/combat-sandbox-lane.md) |
