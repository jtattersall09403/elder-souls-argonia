...
| Vegetation renderer — cells built once, LOD on the GPU, no rebuild on movement | in progress: round 0 (measure, confirm three's BatchedMesh, record the decision) started 2026-09-20; must close before "deliver 16h part 1" | [brief](phases/lanes/vegetation-renderer-lane.md) |
