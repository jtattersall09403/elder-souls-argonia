...
- **16f** ([0070](decisions/0070-vegetation-and-dressing-read-the-record.md), [ledger](research/phase16/16f-ledger.md)): walk the owner check in the [brief](phases/16-foundation-and-places/16f-vegetation-on-frozen-water.md) (jungle floor, the four other sites, the lowland river, the gorge fall, a broken road, the Rockpark stones, the beach, the insects at dusk, the water tint, the delta mouth); eyeball the six Depths of Skyrim wreck hulls before 16g plots a wreck; report the frame rate at the five sites; then `deliver 16g`.
