...
| 6 — reference watershed terrain | in progress | pass 1 compiled: 12×11 km basin refined (channels, region detail noise, canon Blackrose lake+island+3 feeders), flyable, splat-textured. Owner gate feedback 2026-08-23: texturing too coarse + too vanilla → ground-material system redesigned (decision 0011, research recorded). Pass 2 progress: **0011 implemented** (18-material land-cover terrain, CC0+vanilla textures, texture-array shader), feeders carved to bed level (W wet, S connects toward Oliis Bay), shorelines smoothed — deployed for owner flyover. Remaining: portage resolutions (boat-lane hops over land, module 60 §45), collision/LOD/chunking, wet-season flood states |
