...
- **16f round 4 delivered 2026-09-18, walk pending**
  ([0073](decisions/0073-one-copy-per-pixel-a-card-is-baked-from-its-own-mesh-and-the-writer-is-not-the-rule.md),
  [ledger §17](research/phase16/16f-ledger.md)): start the studio and walk
  § Owner check, round 4 in the
  [brief](phases/16-foundation-and-places/16f-vegetation-on-frozen-water.md) —
  quality bands that never fade to nothing, billboard shapes, trees at range,
  seated rocks, jumping onto a rock, the sea bed further out, the console
  under water, reload speed, frame rates.
