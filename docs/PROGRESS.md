...
| Vegetation renderer — cells built once, LOD on the GPU, no rebuild on movement | in progress: round 0 delivered 2026-09-20 ([0082](decisions/0082-vegetation-cells-are-built-once-and-the-gpu-picks-the-rung.md), [baseline](research/vegetation/renderer-rewrite-baseline.md); jungle is the lane's only measuring site, owner 2026-09-20); **rounds 1 and 2 in progress 2026-09-20** (one session, owner 2026-09-20: build behind `?veg=cells`, prove the round-1 targets at the jungle site, remove the old path only after they are met); must close before "deliver 16h part 1" | [brief](phases/lanes/vegetation-renderer-lane.md) |
