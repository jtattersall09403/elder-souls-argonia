...
| S — stats, progression and character-systems **design** (parallel workstream, module 76; decision 0019) | todo | Run-book: module 76 §103.1 (self-contained — "deliver workstream S" is enough). Docs + owner decisions only, no code; skeleton first, then **exactly two batched owner rounds** (direction, then confirmation w/ proposed defaults). Runnable any time alongside 8a–10; must conclude before 10c |
