...
| 8b — water renderer and interaction | in progress | BUILT & DEPLOYED 2026-08-26 (decision 0025): compile_water data, WorldWaterQuery + buoyancy (game-core/water), continuous province surface renderer on the 8a stack (refraction/SSR/foam/underwater/tide/season, tiers ?wq=), crates demo, probes all green (water 53 checks + sky regression). Awaiting owner visual playtest round 1 |
