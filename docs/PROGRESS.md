...
- **16f round 2** ([0071](decisions/0071-every-placed-thing-steps-down-through-bands-and-collides-as-itself.md), [ledger §15](research/phase16/16f-ledger.md)): walk the round-2 check in the [brief](phases/16-foundation-and-places/16f-vegetation-on-frozen-water.md) § Owner check, round 2 (standing on rocks, walking round them, the crossfades, the far ground-cover band, 3D grass up close, the broken and decayed roads, the sea bed near the shore, the reef sites); report the frame rate at the jungle and beside water; eyeball the six Depths of Skyrim wreck hulls before 16g plots a wreck; confirm Jokerine's Seashells permission on its mod page (sourcing-log OPEN row); then `deliver 16g`.
