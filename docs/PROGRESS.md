...
- **16h part 1, check-in 1 done 2026-09-23:** your yard findings are
  ...
  retired (the yard is the fixture); road-wear ground paint cut;
...
- **16k, the place loop ([0099](decisions/0099-places-are-built-in-a-loop-until-the-skill-is-proven.md)), two things to sign before slice 1's place is designed**
  ...
  (2) the first real place: Chasepoint, an old Imperial road station on the
  Gideon–Soulrest road (alternatives Highwater or Claywater Station).
