...
| C — parallel combat workstream (sandbox; feeds 10b) | done: requested bow corrections | Shared bow defaults, click-triggered nocking, facing/arm fixes, 2× gravity, reversed-source backward runs and plain role labels delivered. Grounded leg contact closes both stop failures. Root tests/typecheck and all 16 movement/bow scenes pass; live arrow descent measured. See [0040](decisions/0040-animation-packs-and-combat-parallel-pass.md) round 12. |
...
Latest verified deployment: `3cf2965`, Actions `34131751860`, live bundle
`index-CPwMQa8_.js` (2026-09-07). All Actions gates pass; public bundle and
...
- **Combat:** requested corrections and the completion audit are finished (0040, round 12); deploy for owner playtest. Phase 10b remains the separate studio-integration step.
