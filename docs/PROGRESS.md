...
| 8c — weather and atmosphere | in progress | **round 2 in progress 2026-08-29** — owner round-1 feedback being fixed (rain invisible, lightning w/o clouds, night clouds, coverage variety, storm darkness gradient, black peak bands + purple fly layer = mist-regime fog colour, ripple radius, storm seas, mist force option, fly alt, calendar-driven wet season). Run-book: top of decision [0032](decisions/0032-phase8c-weather-implementation-shape.md); round log there |
...
- **8c round 2 playtest** — round-1 feedback fixes being built 2026-08-29;
  new checklist will land here when round 2 deploys.
