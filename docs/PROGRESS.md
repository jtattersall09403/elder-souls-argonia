...
- **16d** ([0067](decisions/0067-the-apron-is-the-tamriel-map-at-one-to-one.md), [ledger](research/phase16/16d-ledger.md)): walk the owner check in the [brief](phases/16-foundation-and-places/16d-border-apron-and-boundary.md) (the land beyond the border, the sea over it, the wall and its message); then `deliver 16e`.
