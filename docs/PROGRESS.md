...
| 8b — water renderer and interaction | in progress | round-1 fixes DEPLOYED 2026-08-26 (0025 has the defect→fix log): live water clock (world clock pauses ≠ dead water), light-layer fix (sun glints/shadows on water), material-lifecycle perf fix (dispose storm = the fly freeze), depth-writing blit (marker occlusion + hw cull), foam rings, mountain-sheet discard, turbidity contrast, marsh water table, underwater de-banding. Probes: water 68 checks + sky suite green. Awaiting owner playtest round 2 |
