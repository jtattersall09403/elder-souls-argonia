...
| Vegetation renderer — cells built once, LOD on the GPU, no rebuild on movement | closed 2026-09-21 ([0082](decisions/0082-vegetation-cells-are-built-once-and-the-gpu-picks-the-rung.md); rounds 1–2 delivered; owner walk pending) | [brief](phases/lanes/vegetation-renderer-lane.md) |
