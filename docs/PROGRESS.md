...
- **16e** ([0068](decisions/0068-routes-below-the-gate-records-here-realised-in-16h.md), [ledger](research/phase16/16e-ledger.md)): walk the owner check in the [brief](phases/16-foundation-and-places/16e-routes-grading-spans-ferries.md) (the three road asks on the 2D map, three roads and two fords on foot, one ferry through its landing pole, the spans/grades/crossings/services layers); two calls: the Underway basin ferry (unmatched) and the one 200 m dry-hollow bridge on Stormhold–Thorn; then `deliver 16f`.
