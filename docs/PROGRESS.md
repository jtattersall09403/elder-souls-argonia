...
| 8b — water renderer and interaction | in progress | round-4 DEPLOYED 2026-08-28 (0025 = full log): **Tropical Skyrim (33017) ingested as preferred source** (module 90 §74.1a — beds/beach/gravel/mountain textures; the "mossy rock" was the old water_silt texture, painting was correct); slope-driven torrents + cascade shading (spillway bulges → rapids); channels ≥60 % full; wetland/jungle heartlands much wetter (fine pools + rivulet web + deeper dips); whitewater guarantee on major rivers; entry splashes + wake-ring trails; perf (alternate-frame shadows, rtScale 0.9, 10 bands). Awaiting owner playtest round 4 |
