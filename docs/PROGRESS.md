...
| Combat sandbox (Opus lead, 0087) | rounds 0–5 delivered 2026-09-24 (runtime in `packages/character/src/combat` [0089](decisions/0089-the-combat-runtime-is-a-package-with-an-injected-host.md); every built weapon in the starting pack; arrow calibration [0090](decisions/0090-arrow-damage-is-calibrated-to-a-masters-warbow-headshot.md), swing ×0.85, sword crit, timing panel; off hand [0091](decisions/0091-the-off-hand-holds-a-shield-a-weapon-or-a-light.md); stealth [0092](decisions/0092-stealth-is-a-detection-service-the-runtime-feeds.md); thin swim [0093](decisions/0093-swimming-is-a-movement-mode-behind-the-controller-boundary.md)); full visual suite 61/61; owner playtest pending | [brief](phases/lanes/combat-sandbox-lane.md) |
...
| Sound prep (Opus lead, 0087) | in progress: round 1 delivered 2026-09-24 ([0094](decisions/0094-audio-ships-as-opus-webm-sets-read-from-the-plugin-loops-crossfade-at-runtime.md)): the pipeline from `Skyrim - Sounds.bsa` to Opus/WebM, sets read from Skyrim.esm, loop-safe beds; 391 first-consumer files, 4.5 MB in `packages/audio/files`; rounds 2–3 next | [brief](phases/lanes/sound-prep-lane.md) |
