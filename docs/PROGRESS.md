...
| Vegetation renderer — cells built once, LOD on the GPU, no rebuild on movement | in progress: rounds 1–2 delivered 2026-09-21 ([0082](decisions/0082-vegetation-cells-are-built-once-and-the-gpu-picks-the-rung.md)); performance rounds 9, 9b and the round-10 instrument delivered 2026-09-22 ([0084](decisions/0084-the-frame-is-a-triangle-budget.md) + addendum: triangles cut 6.4 M → 3.0 M but the frame did not follow; ~19 ms CPU and ~12 ms GPU are fixed per frame; HUD lines 4/5 now attribute GPU by pass and CPU by stage, `&water=0`, `&pmrem=0`); **round 11 delivered 2026-09-22** (0084 addendum): tiles built once, MID/FAR merged, `&gcquad`, Metal GPU line marked; owner reading pending; round 11 + follow-up delivered 2026-09-22 (0084 round-11 addendum, bdf482bf): ground-cover tiles built once and never blanked, MID/FAR merged, `&gcquad`, Metal GPU line marked wall-time; root cause of the 20 ms found (BatchedMesh multi-draw ranges expanded per instance by ANGLE on Metal); **round 12 delivered 2026-09-22** ([0084](decisions/0084-the-frame-is-a-triangle-budget.md) round-12 addendum): one instanced draw per plant geometry, BatchedMesh path removed, `&gcquad` default 1; owner reading pending; closes when the jungle walk is smooth under budget, then 16h; round 12 accepted by the owner 2026-09-22: 57 fps at rest (was 22), plants unchanged; round 12 follow-up delivered 2026-09-22 (water sampler feedback fix e1facbc6, body pose interpolation d2331495, HUD perf fold 59cf430e); owner accepted 2026-09-22 (water dip, body interpolation after the 3 s-reset fix 31324505, HUD fold): "all good"; round 13 deferred by the owner until after 16h; next: "deliver performance round 13" (part-aware mid tier, brief in the lane doc) | [brief](phases/lanes/vegetation-renderer-lane.md) |
