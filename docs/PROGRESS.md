...
| Combat sandbox (Opus lead, 0087) | in progress: rounds 0–1 delivered 2026-09-24 (runtime in `packages/character/src/combat`, [0089](decisions/0089-the-combat-runtime-is-a-package-with-an-injected-host.md); every built weapon in the starting pack); rounds 2–5 next | [brief](phases/lanes/combat-sandbox-lane.md) |
