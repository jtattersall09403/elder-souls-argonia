...
| 2 | delivered 2026-09-24 | af96af0f | [0096](../../decisions/0096-one-race-record-keyed-by-the-roster-with-morrowinds-packages.md) | whole sim output (`run.mjs --json --matrix`, 12,924 numbers) bit-exact on the sim's tables; 19/19 invariants on the canonical data |
