...
- `world/sources/routes/travel-services.json` (ferries, boat services,
  rootworm placeholders; one graph) and the talk-to-service contract in
  `packages/`; `route-grade` patches; crossings keyed to graph ids (16e).
