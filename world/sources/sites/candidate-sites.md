...
schemaVersion 1 · seed 1109 · 1185 candidate sites · with viewshed scores
...
- **Authored land: 33.87 km²** (of a 54.4 km² bounding square).
- Open sea 16.86 km² · lakes 0.55 km² · deep river/channel 3.11 km².
- Of the authored land, 1.39 km² is shallow marsh (waded, poled, built on).
...
At module 95's Phase 11 fine-tempo density of 18–22 named POIs/km² over D0–D3 ground, 33.87 km² implies roughly 609–745 records if that rate applied everywhere; the D4–D5 rate of 8–12/km² pulls the real total down, and density is a per-region average with a causal shape, never a spread (0041, Part 3).
...
| `cliff-bench` | 65 | flat shelf against a rock face |
...
| `enclosed-clearing` | 7 | flat room ringed by higher land |
| `island` | 57 | land body separated by open water, 0.4-60 ha |
...
| `spring-head` | 47 | upstream terminus of a channel above 12 m |
| `cove` | 70 **(capped)** | sheltered inlet off the sea |
| `natural-harbour` | 17 | sheltered deep water with a landable shore |
| `headland` | 60 **(capped)** | promontory with water on most sides |
...
| `sinkhole` | 0 | closed depression with a rim |
...
| --- | --- |
| firm lowland | 295 |
| border mountains | 285 |
| rootland deep marsh | 124 |
| upland hills | 115 |
| fringe marsh | 87 |
| interior swamp | 68 |
| lake & standing water | 59 |
| mangrove forest | 54 |
| tropical jungle | 46 |
| seasonal floodplain | 21 |
| ocean | 19 |
| deep river corridor | 6 |
| coastal lagoon & salt marsh | 4 |
| tidal delta | 2 |

## Candidates by danger band

D0: 43 · D1: 12 · D2: 165 · D3: 625 · D4: 181 · D5: 159

## Score spread (the supply's character)

- visibility p5/p50/p95: 0.072 / 0.221 / 0.466
- concealment p5/p50/p95: 0.378 / 0.836 / 1.000
- effort-to-reach p5/p50/p95: 0.091 / 0.309 / 0.605
