...
Seed 1103. Supply: 1185 scour sites + 3057 free-ground points. Demand: 580 live records; **550 plotted**, 30 unresolved.
Placed from the homeless batch: {'neighbour-zone': 31, 'region-relaxed': 4, 'eviction-repair': 2, 'relaxed-score': 1, 'spacing-1/2-region-relaxed': 1}.

| zone | live | plotted | homeless | landform wishes from recipe | top landforms |
|---|---|---|---|---|---|
| dunmer-north | 127 | 125 | 2 | 0 | any-firm-ground 70, ravine 9, ridge-end 7, any-shallow-marsh 6 |
| hist-heartland | 116 | 116 | 0 | 0 | any-firm-ground 59, any-shallow-marsh 25, flood-high 4, open-water 4 |
| imperial-fringe | 120 | 110 | 10 | 0 | any-firm-ground 77, ravine 5, ridge-end 5, box-canyon 4 |
| imperial-penal-south | 44 | 36 | 8 | 43 | any-firm-ground 19, open-water 5, any-shallow-marsh 4, flood-high 2 |
| mercantile-coast | 65 | 62 | 3 | 65 | any-firm-ground 27, any-shallow-marsh 13, flood-high 5, open-water 5 |
| naga-kur-deeps | 40 | 37 | 3 | 27 | any-shallow-marsh 25, open-water 7, any-firm-ground 3, islet 1 |
| pirate-freeholds | 31 | 31 | 0 | 0 | any-firm-ground 21, cliff-bench 4, anchor 1, box-canyon 1 |
| saxhleel-coast | 37 | 33 | 4 | 0 | any-firm-ground 15, any-shallow-marsh 9, flood-high 2, anchor 1 |

## Spacing and routes

- nearest-neighbour distance p5 / median / p95: 74 / 125 / 267 m
- same-type pairs closer than 300 m: 1
- median distance to a route: 268 m; fine-tempo records within 300 m of a route: 57 %
- route-visibility sweep (359 samples every 150 m, radius 450 m): mean 3.69 destination/landmark places in sight; dead 10 %, crowded (4+) 45 %
...
| `place.saxhleel-coast.archon-lighthouse` | sightline | `place.saxhleel-coast.archon` | 253 | True |
| `place.saxhleel-coast.archon-lighthouse` | sightline | `place.saxhleel-coast.padomaic-wrecker-beach` | 1076 | True |
| `place.saxhleel-coast.archon-lighthouse` | sightline | `place.saxhleel-coast.gap-reef` | 299 | True |
| `place.saxhleel-coast.archon-lighthouse` | bound | `place.saxhleel-coast.archon` | 253 | — |
...
| `place.saxhleel-coast.gap-reef` | sightline | `place.saxhleel-coast.archon-lighthouse` | 299 | True |
| `place.saxhleel-coast.gap-reef` | bound | `place.saxhleel-coast.archon-lighthouse` | 299 | — |
...
| `place.saxhleel-coast.padomaic-wrecker-beach` | sightline | `place.saxhleel-coast.archon-lighthouse` | 1076 | True |
| `place.saxhleel-coast.padomaic-wrecker-beach` | bound | `place.saxhleel-coast.archon-lighthouse` | 1076 | — |
...
| record | stage | site |
|---|---|---|
| `place.dunmer-north.the-ash-causeway` | neighbour-zone | site.free.any-shallow-marsh-0306 |
| `place.dunmer-north.the-divers-landing` | region-relaxed | site.free.any-firm-ground-0010 |
| `place.dunmer-north.the-last-landing` | neighbour-zone | site.free.any-firm-ground-0085 |
| `place.dunmer-north.the-thorn-bond` | neighbour-zone | site.free.roadside-0474 |
| `place.imperial-fringe.comes-back-slowly` | neighbour-zone | site.free.roadside-0131 |
| `place.imperial-fringe.fort-swampmoth` | neighbour-zone | site.free.any-firm-ground-0607 |
| `place.imperial-fringe.the-broke-column` | neighbour-zone | site.scour.upland-hills.spring-head-028 |
| `place.imperial-penal-south.blasphemer-urn-vault` | neighbour-zone | site.free.roadside-0349 |
| `place.imperial-penal-south.bramman-head` | region-relaxed | site.scour.tidal-delta.river-mouth-000 |
| `place.imperial-penal-south.ledgered-blackguards` | eviction-repair | site.free.any-shallow-marsh-1031 |
| `place.imperial-penal-south.manned-toll-tower` | neighbour-zone | site.scour.firm-lowland.natural-harbour-000 |
| `place.imperial-penal-south.necromantic-dig` | neighbour-zone | site.free.any-firm-ground-1299 |
| `place.imperial-penal-south.rebellion-earthworks` | neighbour-zone | site.free.any-firm-ground-1229 |
| `place.imperial-penal-south.rose-bone-waystation` | neighbour-zone | site.free.roadside-0104 |
| `place.imperial-penal-south.rose-outworks` | neighbour-zone | site.free.roadside-0105 |
| `place.imperial-penal-south.rose-supply-town` | neighbour-zone | site.free.roadside-0108 |
| `place.mercantile-coast.alessian-hull` | neighbour-zone | site.free.any-shallow-marsh-1341 |
| `place.mercantile-coast.bereaved-village-murkmire` | neighbour-zone | site.free.any-shallow-marsh-1195 |
| `place.mercantile-coast.lighter-flotilla` | neighbour-zone | site.free.any-shallow-marsh-1215 |
| `place.mercantile-coast.oliis-ferry-stage` | eviction-repair | site.free.open-water-1018 |
| `place.mercantile-coast.quinrawl-anchorage` | relaxed-score | site.free.any-firm-ground-1240 |
| `place.mercantile-coast.root-gallery-murkmire` | neighbour-zone | site.free.any-shallow-marsh-1185 |
| `place.mercantile-coast.screen-watch` | spacing-1/2-region-relaxed | site.free.roadside-0511 |
| `place.mercantile-coast.soulrest-breaking-yard` | region-relaxed | site.free.any-firm-ground-1289 |
| `place.naga-kur-deeps.drowning-narrows-tidal-gate` | neighbour-zone | site.free.any-shallow-marsh-1036 |
| `place.naga-kur-deeps.naga-village-settled` | neighbour-zone | site.free.open-water-0865 |
| `place.pirate-freeholds.dres-holding-pens` | neighbour-zone | site.free.any-firm-ground-0293 |
| `place.pirate-freeholds.reach-wreck` | neighbour-zone | site.free.open-water-0064 |
| `place.pirate-freeholds.rim-smugglers-ledge-north` | region-relaxed | site.scour.firm-lowland.cliff-bench-053 |
...
| `place.saxhleel-coast.contested-bank` | neighbour-zone | site.free.any-shallow-marsh-0896 |
| `place.saxhleel-coast.gap-reef` | neighbour-zone | site.free.any-shallow-marsh-0859 |
| `place.saxhleel-coast.jungle-root-hollow` | neighbour-zone | site.free.any-firm-ground-0954 |
| `place.saxhleel-coast.lagoon-submerged-xanmeer` | neighbour-zone | site.free.open-water-0769 |
| `place.saxhleel-coast.oliis-coast-lay-by` | neighbour-zone | site.free.roadside-0541 |
| `place.saxhleel-coast.padomaic-wrecker-beach` | neighbour-zone | site.free.any-firm-ground-1124 |
| `place.saxhleel-coast.pearl-lots` | neighbour-zone | site.free.any-shallow-marsh-0701 |
| `place.saxhleel-coast.terrace-village-ridge` | neighbour-zone | site.free.any-firm-ground-1098 |
...
any-firm-ground 291, any-shallow-marsh 83, open-water 28, flood-high 15, ravine 15, ridge-end 13, cliff-bench 10, anchor 9, saddle 9, cove 8, islet 7, box-canyon 6, gorge 6, island 6, spring-head 6, waterfall 6, summit 5, water-narrows 5, enclosed-clearing 4, isthmus 4, pinned (Part 6 meso siting) 4, ford 3, headland 3, land-bridge 1, natural-harbour 1, oxbow 1, river-mouth 1

## Homeless batch (unresolved)

- `place.saxhleel-coast.archon-bonded-row` (tier 0)
- `place.saxhleel-coast.archon-shipyard` (tier 0)
- `place.imperial-fringe.glenbridge` (tier 1)
- `place.imperial-fringe.the-stone-talkers-watch` (tier 1)
- `place.imperial-penal-south.blackrose-drowned-hist` (tier 1)
- `place.imperial-penal-south.three-gate-toll` (tier 1)
- `place.imperial-penal-south.west-market-town` (tier 1)
- `place.naga-kur-deeps.deepmire-refuge` (tier 1)
- `place.saxhleel-coast.archon-shadowscale-sanctuary` (tier 1)
- `place.dunmer-north.the-field-gate-garrison` (tier 2)
- `place.imperial-fringe.onkobra-clay-pits` (tier 2)
- `place.imperial-penal-south.lake-boardwalk-village` (tier 2)
- `place.imperial-penal-south.lake-drowned-village` (tier 2)
- `place.naga-kur-deeps.root-whisper-village` (tier 2)
- `place.imperial-fringe.onkobra-ferry` (tier 3)
- `place.imperial-fringe.onkobra-field-station` (tier 3)
- `place.imperial-fringe.swampmoth-town` (tier 3)
- `place.imperial-fringe.the-empty-steading` (tier 3)
- `place.imperial-fringe.the-quiet-pit` (tier 3)
- `place.imperial-penal-south.lake-divers-yard` (tier 3)
- `place.imperial-penal-south.natural-dive-shaft` (tier 3)
- `place.imperial-penal-south.plague-cordon` (tier 3)
- `place.mercantile-coast.keel-sakka-stilts` (tier 3)
- `place.mercantile-coast.oliis-drake-deep` (tier 3)
- `place.mercantile-coast.whitebone-reef` (tier 3)
- `place.naga-kur-deeps.wreck-submerged-barge` (tier 3)
- `place.dunmer-north.the-slumped-hamlet` (tier 4)
- `place.imperial-fringe.lower-onkobra-paddies` (tier 4)
- `place.imperial-fringe.the-marble-field` (tier 4)
...
|---|---|---|---|---|
| `place.dunmer-north.bogmother` | site.scour.firm-lowland.saddle-012 | saddle | firm lowland | saddle in firm lowland (danger band 4), 327 m from the nearest route; at the water's edge; won on bound, region, parent. |
...
| `place.dunmer-north.hatching-pools` | site.free.roadside-0312 | any-firm-ground | firm lowland | firm ground in firm lowland (danger band 2), 44 m from the nearest route; no free 'spring-head' site was left in the zone, so plain ground; won on culture-clump, bound, region. |
...
| `place.dunmer-north.loriasel-caverns` | site.free.any-firm-ground-0252 | any-firm-ground | upland hills | firm ground in upland hills (danger band 3), 653 m from the nearest route; no free 'sinkhole' site was left in the zone, so plain ground; won on culture-clump, region, remote; needs 1 m of water. |
...
| `place.hist-heartland.guide-camp-gate-side` | site.scour.rootland-deep-marsh.islet-037 | islet | rootland deep marsh | islet in rootland deep marsh (danger band 5), 246 m from the nearest route; at the water's edge; won on culture-clump, bound, region. |
...
| `place.imperial-fringe.fort-swampmoth` | site.free.any-firm-ground-0607 | any-firm-ground | upland hills | firm ground in upland hills (danger band 2), 93 m from the nearest route; its choice #5 landform; won on nearPoint, route, region; placed from the homeless batch at stage 'neighbour-zone'. |
...
| `place.imperial-penal-south.bramman-head` | site.scour.tidal-delta.river-mouth-000 | river-mouth | tidal delta | river mouth in tidal delta (danger band 2), 350 m from the nearest route; at the water's edge; won on nearPoint, parent, route; placed from the homeless batch at stage 'region-relaxed'; needs 1.2 m of water; landform wishes taken from the type recipe (record had none). |
...
| `place.imperial-penal-south.longmont` | committed.longmont | any-firm-ground | fringe marsh | firm ground in fringe marsh (danger band 3), 285 m from the nearest route; no free 'any-shallow-marsh' site was left in the zone, so plain ground; won on region, ring; landform wishes taken from the type recipe (record had none). |
...
| `place.naga-kur-deeps.dead-water-village` | site.free.any-shallow-marsh-1193 | any-shallow-marsh | interior swamp | shallow marsh in interior swamp (danger band 4), 401 m from the nearest route; its choice #2 landform; won on culture-clump, landform, nearPoint. |
...
| `place.naga-kur-deeps.naga-village-settled` | site.free.open-water-0865 | open-water | lake & standing water | open water in lake & standing water (danger band 3), 116 m from the nearest route; at the water's edge; won on danger, parent, landform; placed from the homeless batch at stage 'neighbour-zone'. |
...
| `place.pirate-freeholds.opening-work-barge` | site.scour.firm-lowland.cliff-bench-039 | cliff-bench | firm lowland | cliff bench in firm lowland (danger band 3), 78 m from the nearest route; at the water's edge; won on bound, region, parent; needs 0.6 m of water. |
...
| `place.saxhleel-coast.cantemir-headland` | site.scour.mangrove-forest.flood-high-022 | flood-high | mangrove forest | flood high in mangrove forest (danger band 3), 27 m from the nearest route; at the water's edge; its choice #3 landform; won on culture-clump, nearPoint, landform. |
...
- stances: {'friendly': 66, 'wary': 67, 'hostile': 265, 'neutral': 93, 'guarded': 39, 'sanctuary': 20}
...
|---|---|---|---|---|
| stormhold | 14 | — | 56 | 7 / 47 / 118 |
| thorn | 13 | — | 35 | 7 / 40 / 79 |
| gideon | 14 | — | 78 | 10 / 55 / 146 |
| helstrom | 14 | — | 82 | 4 / 32 / 254 |
| archon | 13 | — | 55 | 6 / 28 / 93 |
| blackrose | 14 | — | 64 | 10 / 44 / 114 |
| lilmoth | 14 | — | 61 | 11 / 27 / 108 |
| soulrest | 14 | — | 39 | 7 / 22 / 75 |
| alten-corimont | 14 | — | 66 | 11 / 60 / 141 |

Rest-cadence gaps (add a rest or soften): `place.dunmer-north.the-crystal-prospectors` (641 m), `place.dunmer-north.the-guar-ground` (945 m), `place.imperial-fringe.sink-field` (616 m), `place.imperial-fringe.vanins-signal` (642 m)

## Clustering — Clark-Evans R per zone (97 A5 / G3)

R = 1 is random in the zone's own shape. Even spacing (R > 1) is ACCEPTED where the typed footprint, proximity and isolation gates require it (owner steer 2026-09-09, reversing the earlier 'R < 1 everywhere' target); what is still wanted is that the settled zones stay the most clustered, because that is where lore puts hamlet clumps. Reported, not gated. Median R 1.099; Evener than random: dunmer-north, imperial-fringe, imperial-penal-south, mercantile-coast, naga-kur-deeps, pirate-freeholds, saxhleel-coast.

| zone | plotted | land km² | mean NN m | same-mask null m | R |
|---|---:|---:|---:|---:|---:|
| dunmer-north | 125 | 7.56 | 150.2 | 137.9 | **1.089** |
| hist-heartland | 116 | 8.98 | 149.1 | 174.7 | **0.853** |
| imperial-fringe | 110 | 6.96 | 146.3 | 136.3 | **1.074** |
| imperial-penal-south | 36 | 0.93 | 141.6 | 109.3 | **1.295** |
| mercantile-coast | 62 | 3.51 | 161.4 | 147.3 | **1.096** |
| naga-kur-deeps | 37 | 2.6 | 199.6 | 181.6 | **1.099** |
| pirate-freeholds | 31 | 0.8 | 134.2 | 96.5 | **1.391** |
| saxhleel-coast | 33 | 1.72 | 161.0 | 135.9 | **1.185** |
