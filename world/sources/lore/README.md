...
| File | Purpose |
|---|---|
| [extrapolation/PROGRESS.md](extrapolation/PROGRESS.md) | Packet status, sweep log, API recipes, canon-tier definitions. **Resume here.** |
| [extrapolation/gap-register.md](extrapolation/gap-register.md) | What the game must know that canon doesn't state, with status per gap |
| [extrapolation/argonia-4e201-state.md](extrapolation/argonia-4e201-state.md) | The 4E 201 synthesis: government, cities, economy, routes, danger |
| [extrapolation/owner-questions.md](extrapolation/owner-questions.md) | Decisions escalated to the owner, with recommendations |
| [extrapolation/quest-plan-deltas.md](extrapolation/quest-plan-deltas.md) | Proposed `docs/quests/` changes — **not applied**; a follow-up agent owns these |

## Dossier backlog

Wanted next (create when a task first touches them):
Umbriel in depth (L15), Ruins of Mazzatun (L23), Mages Guild / Synod / College of
Whispers in the Fourth Era (L24–L26 — see gap G4.10), *Varieties of Faith: The
Argonians* (L33), Argonian Cuisine, *The Seasons of Argonia*.
