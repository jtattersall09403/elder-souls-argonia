...
TEXTURES = [
    ...
    ("textures/effects/fxfogheavy.dds", True, "skirt-fog",
     "skirt foam/fog planes (fxwaterfallskirt*); -0.545 x2 down, +0.362 up"),
    ("textures/effects/cloudtile.dds", True, "ground-mist",
     "fxmistlow01 ground-mist disc; U +0.030 / V -0.017 on 34 s / 60 s loops"),
