...
const BLOCKS = [SYSTEM_TEXT, COMBAT_SANDBOX_TEXT, EQUIPMENT_TEXT, FERRY_TEXT, TRAVEL_TEXT, TRAVEL_UI_TEXT, HYDROLOGY_NAME_TEXT, PLACE_NAME_TEXT, QUEST_TITLE_TEXT];
