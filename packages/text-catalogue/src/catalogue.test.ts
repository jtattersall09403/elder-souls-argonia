...
const BLOCKS = [SYSTEM_TEXT, COMBAT_SANDBOX_TEXT, COMBAT_CALLOUT_TEXT, SANDBOX_HUD_TEXT, EQUIPMENT_TEXT, INVENTORY_TEXT, FERRY_TEXT, TRAVEL_TEXT, TRAVEL_UI_TEXT, HYDROLOGY_NAME_TEXT, PLACE_NAME_TEXT, QUEST_TITLE_TEXT, STATS_TEXT];
