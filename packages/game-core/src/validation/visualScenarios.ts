...
export const VISUAL_SCENARIOS: Record<VisualScenarioId, VisualScenario> = {
  ...
  "elven-dagger-reach": {
    id: "elven-dagger-reach",
    label: "Elven dagger: measured opening attack",
    warmup: 0.5,
    duration: 2.5,
    player: { position: [0, Y, 0], yaw: Math.PI, weaponId: "elven-dagger" },
    enemy: SOLO_ENEMY,
    cues: [{ from: 0.3, to: 0.39, actions: ["light"] }],
  },
  "elven-sword-reach": {
    id: "elven-sword-reach",
    label: "Elven sword: measured opening attack",
    warmup: 0.5,
    duration: 2.5,
    player: { position: [0, Y, 0], yaw: Math.PI, weaponId: "elven-sword" },
    enemy: SOLO_ENEMY,
    cues: [{ from: 0.3, to: 0.39, actions: ["light"] }],
  },
  "light-chain": {
