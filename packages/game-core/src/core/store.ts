...
export const initialSnapshot: GameSnapshot = {
  ...
  bowNockSpeedMultiplier: 1,
  bowDrawSpeedMultiplier: 1,
...
export const useGameStore = create<GameStore>((set) => ({
  ...
  reset: () => set((state) => ({
    ...
    bowNockSpeedMultiplier: state.bowNockSpeedMultiplier,
    bowDrawSpeedMultiplier: state.bowDrawSpeedMultiplier,
