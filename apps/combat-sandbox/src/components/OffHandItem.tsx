...
import { RIG_SOCKET_ROTATION } from "../game/anim/animationManifest";
import type { WeaponSocketTransform, WeaponVisualProfile } from "../game/core/types";
...
export function OffHandItem({
  ...
  const gltf = useGLTF(`${import.meta.env.BASE_URL}${profile.asset}`);
  const mount = useMemo(() => {
