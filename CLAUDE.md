...
- **Get visual feedback from the user.** Work up to the point where it would be sensible to get visual feedback from the user, then hand off to them, tell them what to do, what to check, and how to feed back, in plain english.
